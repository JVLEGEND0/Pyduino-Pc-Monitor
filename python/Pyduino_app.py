import psutil, time, requests, serial, sys, spotipy, unicodedata
...
'''
--------- ALERT !!!!!!!! -----------
Before running the code, make sure to edit the credentials below.
'''
...
PATH_SENSOR = '/intelcpu/0/temperature/6'
...
def get_cpu_temp():
    ...
    sensor_path = PATH_SENSOR #It may vary from PC to PC; this one was tested on an Intel processor.
